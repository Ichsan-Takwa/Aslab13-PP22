...
def jumlahData():
    ...
    dir_file = r'C:\Users\Heuchler\Downloads\Tugas Belum Seles atau diasistensi\Tugas 10 Pengantar Pemrograman\{}.txt'.format(nama_file)
    try:
        f = open(dir_file, "r")
        count=0
        for x in f:
...
def tambah():
    ...
    Daftar_Mahasiswa[nama,email, password] = mahasiswa
    menu()
